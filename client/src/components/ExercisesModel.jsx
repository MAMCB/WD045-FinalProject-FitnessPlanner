...
const ExercisesModel = ({ setIsModalOpn, workoutExer }) => {
  ...
  return (
    <>
      ...
      >
        <div className="relative p-4 w-full flex justify-center m-auto ">
                ...
                {workoutExer.exercises.map((workout, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <svg
                        data-accordion-icon=""
                        className="md:w-3  h-3 rotate-180 shrink-0"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 10 6"
                    ...
                    >
                      <div className="p-1 md:p-5 border border-b-0 border-gray-200 dark:border-gray-700 flex flex-col lg:flex-row gap-3">
                        <div>
                          <img
