      ...
      <div className="max-w-7xl mx-auto h-screen relative">
        <div>
          <div className="position-text-in-center z-10">
            <h1 className="text-primary-color text-8xl font-bold">
            FitLife
            </h1>
            <p className="text-primary-color text-3xl text-center">Fitness -Planner</p>
          </div>
          <div className="flex flex-col absolute z-10 left-0 bottom-10 items-baseline justify-end">
            ...
            <p className="text-primary-color mb-2">Already have an account?</p>
            <button
