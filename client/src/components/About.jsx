      ...
      <section className="bg-white shadow dark:bg-gray-900 py-[100px] px-[40px]">
        <div className="mb-[50px] w-[96%] lg:w-[800px] lg:m-auto">
          ...
          <p className="text-center text-gray-500 mb-6 dark:text-gray-400">
            We are a group of Fullstack Web Developer graduates from WBS-Coding
            School.This was our final project for the batch of October 2023 to
            February 2024, where we applied all our knowledge by creating this
            MERN stack Web application with authentication and full CRUD
            functionalities. The idea of the app came from the need of wanting
            to have an application where the user can create, store and track
            all their fitness workout history, creating in this way a hub for
            their own personal fitness activities. Made in only 3 weeks we are
            very proud of our results and aim to add new features to it in the
            near future.
          </p>
        </div>
